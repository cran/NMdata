...
$TABLE ROW ID KA Q FILE=xgxr021_res.txt

$TABLE ID V2 V3 FORMAT=tF13.4 FILE=xgxr021_res_vols.txt

$TABLE ID CL FIRSTONLY FORMAT=,1PE15.8 FILE=xgxr021_res_fo.txt
