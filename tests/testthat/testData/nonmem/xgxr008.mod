$PROBLEM  PK. xgxr006 with row in output table
...
$DATA ../data/xgxr1_flag0.csv IGNORE=@
      ACCEPT=(DOSE.GE.10,WEIGHTB>100)
...
$TABLE ROW KA V2 CL V3 Q IPRED DV FILE=xgxr008_res.txt
