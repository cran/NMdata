...
#Created 2022-10-24 at 12:12

xpose.runno <- '028.mod'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/data/home/philipde/wdirs/NMdata/tests/testthat/testData/nonmem/xgxr028.dir2/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/share/perl/5.26.1/PsN_5_2_6/R-scripts' # This is not used
raw.results.file <- 'raw_results_xgxr028.csv'
theta.labels <- c('POPKA','POPCL','POPV2','POPV3','POPQ')
theta.fixed <- c(FALSE,FALSE,FALSE,FALSE,FALSE)
omega.labels <- c('OMEGA(1,1)','OMEGA(2,2)','OMEGA(3,3)','OMEGA(4,4)','OMEGA(5,5)')
omega.fixed <- c(FALSE,FALSE,FALSE,TRUE,TRUE)
