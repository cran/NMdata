...
$TABLE ROW ID KA Q FILE=xgxr035_res.txt

$TABLE ID V2 V3 FORMAT=tF13.4 FILE=xgxr035_res_vols.txt

$TABLE ID CL FIRSTONLY FORMAT=,1PE15.8 FILE=xgxr035_res_fo.txt
NOPRINT NOAPPEND ONEHEADER

;; From Ahmed
$TABLE ROW ID IPRED FORMAT=t1PG23.16 NOPRINT ONEHEADERPERFILE NOTITLE FILE=xgxr035_tabres.txt
