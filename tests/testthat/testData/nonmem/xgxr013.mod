...
$PROBLEM    PK. NO ID OR ROW IN FIRSTONLY TABLE. RES TABLE WITHOUT ROW.

;@ Variables 17/20 @;
$INPUT ROW ID NOMTIME TIME EVID CMT AMT DV FLAG STUDY
BLQ CYCLE DOSE PART PROFDAY PROFTIME WEIGHTB eff0

$DATA     ../data/xgxr2_flag0.csv IGNORE=@ ACCEPT(DOSE.GT.20)
...
$TABLE KA V2 FILE=xgxr013_fo1.txt FIRSTONLY NOPRINT 
$TABLE CWRES PRED IPRED FILE=xgxr013_res1.txt NOPRINT 
