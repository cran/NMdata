...
#Created 2022-10-24 at 16:37

xpose.runno <- '023.mod'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/data/home/philipde/wdirs/NMdata/tests/testthat/testData/nonmem/xgxr023.dir2/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/share/perl/5.26.1/PsN_5_2_6/R-scripts' # This is not used
raw.results.file <- 'raw_results_xgxr023.csv'
