$PROBLEM    003 with + a redundant output table
...
$TABLE ROW KA Q FILE=xgxr019_res.txt

$TABLE ID V2 V3 FORMAT=tF13.4 FILE=xgxr019_res_vols.txt

$TABLE ID V3 FORMAT=tF11.4 FILE=xgxr019_res_vols2.txt

$TABLE ID CL FIRSTONLY FORMAT=,1PE15.8 FILE=xgxr019_res_fo.txt
